This repository let you apply real-time shaders to [PRISMA](https://github.com/patriciogonzalezvivo/prisma) folders using [glslViewer](https://github.com/patriciogonzalezvivo/glslViewer).
